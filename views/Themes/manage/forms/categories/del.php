...
if ( !empty($this->item['permit']['del']) ) {
	...
	$arr['body'] = "You want to delete <span class=\"fwb\">\"{$this->item['name_th']} ({$this->item['name_en']})\"</span> ?";
	...
	$arr['body'] = "You can not delete <span class=\"fwb\">\"{$this->item['name_th']} ({$this->item['name_en']})\"</span>";
