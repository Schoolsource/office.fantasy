...
if ( !empty($this->item['permit']['del']) ) {
	...
	$arr['form'] = '<form class="js-submit-form" action="'.URL. 'products/del"></form>';
	$arr['hiddenInput'][] = array('name'=>'id','value'=>$this->item['id']);
	$arr['body'] = "You want to delete <span class=\"fwb\">\"{$this->item['pds_name']} \"</span> ?";
	...
	$arr['body'] = "You can not delete <span class=\"fwb\">\"{$this->item['pds_name']} \"</span>";
