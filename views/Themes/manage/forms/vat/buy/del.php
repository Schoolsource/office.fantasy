...
if ( !empty($this->item['permit']['del']) ) {
	...
	$arr['form'] = '<form class="js-submit-form" action="'.URL. 'tax/del"></form>';
	$arr['hiddenInput'][] = array('name'=>'id','value'=>$this->item['id']);
	$arr['body'] = "You want to delete <span class=\"fwb\">\"{$this->item['slipt']} - {$this->item['sup_name']}\"</span> ?";
	...
	$arr['body'] = "You can not delete <span class=\"fwb\">\"{$this->item['sale_name']} \"</span>";
